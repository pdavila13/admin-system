...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'portalaplicacions' => [
            'driver' => 'mysql',
            'host' => env('PORTALAPP_DB_HOST', '127.0.0.1'),
            'port' => env('PORTALAPP_DB_PORT', '3306'),
            'database' => env('PORTALAPP_DB_DATABASE', 'forge'),
            'username' => env('PORTALAPP_DB_USERNAME', 'forge'),
            'password' => env('PORTALAPP_DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
